...
int neoPixelPin = 4;//Change the pin numbers according to your board
...
int start2 = 2; // 2 for 8 neopixel ring, 6 for 24 neopixel ring and so on
int start3 = 4; // 4 for 8 neopixel ring, 12 for 24 neopixel ring and so on
int start4 = 6; // 6 for 8 neopixel ring, 18 for 24 neopixel ring and so on
